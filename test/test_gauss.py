...
w0 = 90.0
ratio = "1/e"
u_src = sdt.gaussian_wave(f, w0, x_src, y_src)
print("Gauss focus distance: %.1f λ" % f)
print("Gauss focus diameter: %.1f λ" % (2*w0))
...
# Size of Gaussian beam
wx, wy = sdt.beam_width(u_src, x_src, y_src, ratio)
if wx is None:
    print("Source beam diameter: ---")
else:
    print("Source beam diameter: %.1f λ" % wx)
